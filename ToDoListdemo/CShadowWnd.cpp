...
//CShadowWnd³ÉÔ±º¯Êý
//CShadowWnd::CShadowWnd() = default;
//
//inline LPCTSTR CShadowWnd::GetWindowClassName() const
//{
//	return _T("UIShadow");
//};

//inline UINT CShadowWnd::GetClassStyle() const
//{
//	return UI_CLASSSTYLE_FRAME;
//};

//inline void CShadowWnd::OnFinalMessage(HWND)
//{
//	delete this;
//};
